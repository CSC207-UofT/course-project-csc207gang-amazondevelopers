...
public class DeleteProductsGateway {
    ...
    public boolean deleteProducts(List<String> listIds){
        ...
        if (!(file.length() == 0)) {
            ...
            HashMap<String, Object> productSavedHash = rw.readFromFile("src/Main2/IdToProduct.ser");
            HashMap<String, Object> tagToIDListHash = rw.readFromFile("src/Main2/Product.ser");
